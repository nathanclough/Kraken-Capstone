...
/* package contracts-0.1.0.0 */
#ifndef VERSION_contracts
#define VERSION_contracts "0.1.0.0"
#endif /* VERSION_contracts */
#ifndef MIN_VERSION_contracts
#define MIN_VERSION_contracts(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_contracts */
...
#define CURRENT_COMPONENT_ID "contracts-0.1.0.0-inplace-contracts"
